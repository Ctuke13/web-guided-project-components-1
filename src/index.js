...
//   imageEl.src = imgURL.imageURL;
//   imageEl.style.height = "10em";
//   return imageEl;
// }

// imageData.forEach((obj) => {
//   const imgEl = makeImage(obj);
...
function makePanel({ title, content }) {
  ...
  panelButtons.addEventListener("click", () => {
     ...
     * 3. Show panel content => 2nd click hide the panel content
     */
...
const panelEls = panelData.map((panelObj) => {
  return makePanel(panelObj);
});

panelEls.forEach((el) => accordion.appendChild(el));
